...
public class EnemyA02 extends Enemy {
    ...
    public EnemyA02(@NotNull final Stage parent, final float x, final float y) {
        super(parent);
        position = new ImmutableVector2<>(x, y);
        direction = 0;
    }

    public EnemyA02(@NotNull final Stage parent, final Vector2<Float> position) {
        super(parent);
